...
class Response extends Message implements Output {
	...
	public function text($value) {
		return $this
			->setType(ContentType::TEXT_PLAIN)
			->setBody($value);
	}
	...
	public function render($template, array $context = []) {
		...
		return $this
			->setType(ContentType::TEXT_HTML)
			->setBody($twig->render($template, $context));
	}
	...
	public function json($data) {
		return $this
			->setType(ContentType::APPLICATION_JSON)
	...
	public function redirect($location, $permanent = false) {
		return $this
			->setStatus($permanent ? Status::PERMANENT_REDIRECT : Status::TEMPORARY_REDIRECT)
	...
	public function file($path) {
		return file_exists($path)
			? $this
				...
				->setType(mime_content_type($path))
	...
	public function addCookie($name, $value, $lifetime = 3600) {
		$this->cookies[$name] = [self::COOKIE_CREATE, $value, $lifetime];
		return $this;
	}
	...
	public function deleteCookie($name) {
		$this->cookies[$name] = [self::COOKIE_DELETE];
		return $this;
	}
